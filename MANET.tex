...
%			
	...
	\label{section: analogy}
		...
		\label{subsec: analogy_of_node_model}
			...
			And the dendrites and axons are seperated, which reveals the separation of transmission and reception in neuron cell. 
			Meanwhile, the information reception and fusion is parallelled processed within neuron cell, proving the parallel characteristic of information reception, fusion and processing.
			The information is transmitted omnidirectionally by axon while it's received directionally by dendrites at the synapse.
			Information is gradually integrated hierachically in dendrites, which means that the information is also processed while being transmitted,  and is then fused integrally at the inner of the neuron.
			Similar to the communication system, neuron 
			Neurons varies in structure and function, and 
	...
	\label{section: general_design}
		...
		\subsection{Design of General NANET Architecture}
			...
			\subsubsection{Adaptability of Network Structure}
				...
				which appears that the NANET topology is rapidly changing.
