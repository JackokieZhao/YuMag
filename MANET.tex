	...
	\label{section: general_design}
		...
		\subsection{Design of NANET Node}
			...
			\subsubsection{Design of Information Transmission and Reception Mechanism}
				In the design of NANET nodes, the information transmission and reception are seperated guranteed by the seperation of transmission antenna and reception antenna.
				information is sent employing omnidirectional antennas and relayed in the form of broadcast. 
				...
				Therefore, the NANET node model we proposed, which is an intelligent node equipped with transmitting, processing, and storage(Fig. \ref{fig: NANET_node}).
