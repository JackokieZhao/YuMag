...
%	\title{Neuron Analogy Network}
	...
	\begin{abstract}
		...
		Then, we elaborate the information transmission mechanism of neural netwroks, and compare the mechanisim with that of HWN in detail, including the node model, network structure, and transmission protocol. 
	...
	\label{section: information_transmit}
		...
		The nervous network achieves the basic function of signal transduction and information transmission with specialized characteristics.
		...
		\subsection{General Characteristics of Neurons}
			...
			\subsubsection{Structure Characteristics of Neurons}
				...
				\begin{figure*}[htbp]
					...
					\end{minipage}}
					\subfigure[Different shapes of neurites.]{
						\begin{minipage}[c]{0.46\linewidth}
							\includegraphics[width=3.3in]{figures/node_het}
							\label{fig: node_het}
					\end{minipage}}
					\caption{Different shapes of neuron and its elementary structure model.}
				\end{figure*}
		...
		\subsection{Overall Characteristics of Neural Networks}
			...
			\subsubsection{Information Transmission between Neurons}
				...
				The postsynaptic neuron integrates all these complex ionic and chemical signals to produce the action potentials. 
			...
			\subsubsection{A Scale-free Network Structure Subjected to Power-law Distribution}
				...
				In terms of network scale, the neural network obeys the so-called power law distribution (scale-free) that has a certain structural universality\cite{eguiluz2005scale}.
				...
				Meanwhile, the neural networks is with short average path length, big clustering coefficient, and more clustered feature compared to random networks, which represents the small-world characterisctic in a sense\cite{eguiluz2005scale}.
	...
	\label{section: analogy}
		...
		\subsection{Analogy of Transmission Protocol}
			...
			whereas the electric synapses transmission  is often used as a synchronization mechanism for coordinating multiple sets of neuronal activities, which is similar to signaling protocols in communication networks\cite{kandel2000principles}.
	...
	\label{section: general_design}
		...
		\subsection{Design of General NANET Architecture}
			...
			\subsubsection{Seperation of Service and Control Channels}
				...
				Signaling information doesn't require further amplification due to its shortness.
				And it can't be processed, meaning that it has the characteristic of invariance.
		...
		\subsection{Design of Transmission Protocol of NANET}
			...
			\subsubsection{Content Synergy in Application Layer}
				...
				Thus, users can be adequate to obtain the content requested in the surrounding nodes, which would improve the efficiency of the users' acquisitions of data resources.
		...
		\label{section: framework}	
			...
			\subsubsection{Task-oriented Active Construction of Network Topology}
				...
				We can make use of complex networks\cite{boccaletti2006complex}, topology, 
			...
			\subsubsection{Service-Oriented Dynamic Resource Scheduling}
				...
				we would naturally utilize the principles of economics to solve, such as the basic economics of Nash equilibrium theory in game theory\cite{gibbons1992primer}.
			...
			\subsubsection{Content-Oriented Distributed Collaborative Transmission}
				...
				The NANET would apply the techniques of time division multiplex(TDM), frequency division multiplex(FDM), and combine the directional antennas to enlarge the efficiency of space utilization, as the neurons does in dendrites' information integration.
